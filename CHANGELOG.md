...
- `CATALOG.md` status of 012-01-0001 moved from `planned` to `paired`. Paired count 9 to 10, planned count 21 to 20. The CATALOG title for 012-01-0001 aligned to the booklet frontmatter (comma rather than colon). With this, all ten v1.0 announcement-target booklets are paired.
