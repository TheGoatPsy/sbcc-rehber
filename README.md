<p align="center">
  <img src="./assets/banner.svg" alt="Claude Code for Social Scientists — Sosyal Bilimciler İçin Claude Code Rehberi banner. Author Onour Impram, ORCID 0000-0003-1076-3928, Zenodo concept DOI 10.5281/zenodo.20289687, dual licensed Apache 2.0 plus CC-BY-NC-SA 4.0, v2.1.0.">
</p>
...
> **Status:** v2.1.0 release. Twelve released booklets in Turkish and English, human-reviewed and citation-audited, plus ten companion Claude Code project skills that turn the booklets into reusable workflows. v2.1.0 adds the first Data Analysis booklet, Reproducible Quantitative Workflows, motivated by survey evidence that quantitative data analysis is the dominant social-science use of coding agents. The skills install with pip (`social-cc-plugin`) or as a Claude Code plugin.
...
The v2.1.0 surface includes ten Claude Code project skills under [`.claude/skills/`](./.claude/skills/). The booklets carry theory, pedagogy, and scholarly framing. The skills carry repeatable workflows, audit checklists, and safe operating boundaries.
...
See [`meta/roadmap.md`](./meta/roadmap.md) for the public phase plan. The current release is v2.1.0, which adds the first Data Analysis booklet (Reproducible Quantitative Workflows) on top of the eleven booklets and ten companion project skills shipped through v2.0.0. A later major milestone, the full thirty-booklet catalog with a living lab, conference citations, and instructional use, is targeted for v3.0.
