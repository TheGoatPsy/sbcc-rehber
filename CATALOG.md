...
**Last updated:** 2026-05-29 (v2.3.0 release: Turkish-language quality revision, the prose of all thirteen booklets rewritten in the author's native voice, no booklet added or removed. Earlier the same day: v2.2.0 release with booklet 008-02-0001, v2.1.0 release with booklet 008-01-0001, and v2.0.0 release with audit and CI hardening, booklet 001-01-0004 promoted to release, companion website, and JOSE paper)
